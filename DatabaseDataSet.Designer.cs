...
namespace CrytoWallet {
    ...
    public partial class DatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class AccountDataTable : global::System.Data.TypedTableBase<AccountRow> {
            ...
            private global::System.Data.DataColumn columnAuthenticator;
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public global::System.Data.DataColumn AuthenticatorColumn {
                get {
                    return this.columnAuthenticator;
                }
            }
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public AccountRow AddAccountRow(string Email, string Username, string Password, int Authenticator) {
            ...
            internal void InitVars() {
                ...
                this.columnAuthenticator = base.Columns["Authenticator"];
            }
            ...
            private void InitClass() {
                ...
                this.columnAuthenticator = new global::System.Data.DataColumn("Authenticator", typeof(int), null, global::System.Data.MappingType.Element);
                base.Columns.Add(this.columnAuthenticator);
                ...
                this.columnAuthenticator.AllowDBNull = false;
            }
        ...
        public partial class AccountRow : global::System.Data.DataRow {
            ...
            public int Authenticator {
                get {
                    return ((int)(this[this.tableAccount.AuthenticatorColumn]));
                }
                set {
                    this[this.tableAccount.AuthenticatorColumn] = value;
                }
            }
        }
...
namespace CrytoWallet.DatabaseDataSetTableAdapters {
    ...
    public partial class AccountTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("Authenticator", "Authenticator");
            this._adapter.TableMappings.Add(tableMapping);
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Account] WHERE (([Email] = @Original_Email) AND ([Username] = " +
                "@Original_Username) AND ([Password] = @Original_Password) AND ([Authenticator] =" +
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Username", global::System.Data.SqlDbType.VarBinary, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Username", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Authenticator", global::System.Data.SqlDbType.NChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Authenticator", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Account] ([Email], [Username], [Password], [Authenticator]) VA" +
                "LUES (@Email, @Username, @Password, @Authenticator);\r\nSELECT Email, Username, Pa" +
                "ssword, Authenticator FROM Account WHERE (Email = @Email)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Username", global::System.Data.SqlDbType.VarBinary, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Username", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Authenticator", global::System.Data.SqlDbType.NChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Authenticator", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Account] SET [Email] = @Email, [Username] = @Username, [Password] = @Password, [Authenticator] = @Authenticator WHERE (([Email] = @Original_Email) AND ([Username] = @Original_Username) AND ([Password] = @Original_Password) AND ([Authenticator] = @Original_Authenticator));
SELECT Email, Username, Password, Authenticator FROM Account WHERE (Email = @Email)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Username", global::System.Data.SqlDbType.VarBinary, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Username", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Authenticator", global::System.Data.SqlDbType.NChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Authenticator", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Username", global::System.Data.SqlDbType.VarBinary, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Username", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Authenticator", global::System.Data.SqlDbType.NChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Authenticator", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        }
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CrytoWallet.Properties.Settings.Default.C__USERS_FAMILY_SOURCE_REPOS_CRYTOWALLET_DATABASE_MDFConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Email, Username, Password, Authenticator FROM dbo.Account";
        ...
        public virtual int Delete(byte[] Original_Email, byte[] Original_Username, byte[] Original_Password, string Original_Authenticator) {
            if ((Original_Email == null)) {
                throw new global::System.ArgumentNullException("Original_Email");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[0].Value = ((byte[])(Original_Email));
            }
            ...
            if ((Original_Authenticator == null)) {
                throw new global::System.ArgumentNullException("Original_Authenticator");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[3].Value = ((string)(Original_Authenticator));
            }
        ...
        public virtual int Insert(byte[] Email, byte[] Username, byte[] Password, string Authenticator) {
            if ((Email == null)) {
                throw new global::System.ArgumentNullException("Email");
            }
            else {
                this.Adapter.InsertCommand.Parameters[0].Value = ((byte[])(Email));
            }
            if ((Username == null)) {
                throw new global::System.ArgumentNullException("Username");
            }
            else {
                this.Adapter.InsertCommand.Parameters[1].Value = ((byte[])(Username));
            }
            if ((Password == null)) {
            ...
            if ((Authenticator == null)) {
                throw new global::System.ArgumentNullException("Authenticator");
            }
            else {
                this.Adapter.InsertCommand.Parameters[3].Value = ((string)(Authenticator));
            }
        ...
        public virtual int Update(byte[] Email, byte[] Username, byte[] Password, string Authenticator, byte[] Original_Email, byte[] Original_Username, byte[] Original_Password, string Original_Authenticator) {
            if ((Email == null)) {
                throw new global::System.ArgumentNullException("Email");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[0].Value = ((byte[])(Email));
            }
            if ((Username == null)) {
                throw new global::System.ArgumentNullException("Username");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[1].Value = ((byte[])(Username));
            }
            if ((Password == null)) {
                throw new global::System.ArgumentNullException("Password");
            }
            ...
            if ((Authenticator == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(Authenticator));
            }
            if ((Original_Email == null)) {
                throw new global::System.ArgumentNullException("Original_Email");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[4].Value = ((byte[])(Original_Email));
            }
            if ((Original_Username == null)) {
                throw new global::System.ArgumentNullException("Original_Username");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[5].Value = ((byte[])(Original_Username));
            }
            if ((Original_Password == null)) {
                throw new global::System.ArgumentNullException("Original_Password");
            }
            ...
            if ((Original_Authenticator == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Original_Authenticator));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(byte[] Username, byte[] Password, string Authenticator, byte[] Original_Email, byte[] Original_Username, byte[] Original_Password, string Original_Authenticator) {
            return this.Update(Original_Email, Username, Password, Authenticator, Original_Email, Original_Username, Original_Password, Original_Authenticator);
        }
    }
